...
parser.add_argument('--lr', type=float, default=0.01, help='Initial learning rate. [0.1 for amazon and 0.001 for yelp]')
...
train_history = model.fit(train_dataset, batch_size=args.batch_size, epochs=10)
